...
public class DataInitializer {
    ...
    CommandLineRunner initDatabase(PetRepository repository) {
        return args -> {
            // Clears existing data to ensure fresh URLs are used
            ...
            repository.saveAll(List.of(
                ...
                new Pet(null, "Oliver", "Parrot", "Bird", 500.0, "Colorful and talkative parrot.", "https://images.unsplash.com/photo-1522926123923-29666244f149?auto=format&fit=crop&w=800"),
                new Pet(null, "Daisy", "Cockatiel", "Bird", 200.0, "Sweet and whistly cockatiel.", "https://images.unsplash.com/photo-1555844019-a29f40c66b1e?auto=format&fit=crop&w=800")
            ));
        };
    }
}
